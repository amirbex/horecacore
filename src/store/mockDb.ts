...
const DEFAULT_CONTENT: SiteContent = {
  ...
  heroDescription: "ما در HoReCa Core با ترکیب دانش مدیریت ، مهندسی فرآیند و هنر مهمان‌نوازی، پروژه‌های شما را از یک ایده اولیه به کسب‌وکاری پایدار و سودآور تبدیل می‌کنیم.",
  ...
  teamMembers: [
    {
      ...
      image: "/pic/team/aliazari.jpg",
    },
    {
      id: "2",
      name: "امیر زمانی",
      role: "هم‌بنیان‌گذار و مدیر عملیات",
      tasks: ["استراتژیست و تحلیل‌گر کسب‌وکار", "مطالعات امکان‌سنجی و مدل‌سازی", "طراحی فرایندهای عملیاتی"],
      image: "/pic/team/amir.jpg",
    },
    {
      id: "3",
      name: "آریا سهرابی",
      role: "مدیر اجرایی",
      tasks: ["نظارت بر اجرای پروژه", "مدیریت میدانی راه‌اندازی", "هماهنگی بین بخشی و کنترل کیفیت"],
      image: "/pic/team/aria.jpg",
    },
    {
      id: "4",
      name: "امیر نجفی",
      role: "مدیر برندینگ و هویت بصری",
      tasks: ["طراحی هویت یکپارچه برند", "تدوین نظام بصری و هویت کلامی", "طراحی تجربه کاربری و رابط‌های دیجیتال"],
      image: "/pic/team/amirnajafi.jpg",
    },
    {
      id: "5",
      name: "وحید رضازاده",
      role: "طراح فنی و داخلی",
      tasks: ["طراحی نقشه‌های فنی و زیرساختی", "طراحی داخلی و ارگونومی فضا", "طراحی گردش کار و ایستگاه‌های عملیاتی"],
      image: "/pic/team/vahid.jpg",
    }
  ],
  networkPartners: [],
  settings: {
